...
function Footer() {
  return (
    <div className="flex gap-5 w-full h-screen bg-zinc-900 p-20">
      <div className='w-1/2 flex flex-col h-full justify-between font-["Test_Founders_Grotesk_X_Condensed"]'>
      ...
      <div className="w-1/2">
        <h1 className='text-[8vw] uppercase leading-none -mb-10 font-["Test_Founders_Grotesk_X_Condensed"]'>
          Presentations
          <div className="dets font-['Neue_Montreal'] mt-[12vw]">
